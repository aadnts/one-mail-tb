...
You use an ontology and shacl constraints as references to extract information.
...
The schacl constraints delimited by triple backticks is:
```
...
## 4. Strict Compliance
Use only the classes and properties provided in the ontology to extract nodes and relations.
Do not use any classes or properties that are not explicitly provided in the ontology.
You must solely:
1. Identify nodes which are instances of thez classes defined in the ontology
2. Identify  relations between the classes defined in the ontology
